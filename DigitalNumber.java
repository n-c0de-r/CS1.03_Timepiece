...
/**
 * The DigitalNumber class represents a digital number display that can hold
...
public class DigitalNumber
{
    ...
    /**
     * Constructor for objects of class DigitalNumber.
     * Set the limit at which the display rolls over.
     * @param rollOverLimit   The number at which the display resets to 0.
     */
    public DigitalNumber(int rollOverLimit)
    {
        limit = rollOverLimit;
        value = 0;
    }
     ...
     * @param replacementValue  Integer number to which the display will be set.
     */
    public void setValue(int replacementValue)
    {
        ...
        // One line solution: value = Math.abs(replacementValue % limit);
    }

    /**
     * Increment the display value by one,
     * rolling over to zero if the limit is reached.
     */
